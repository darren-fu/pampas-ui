...
public class HttpTools {
    ...
    public static void main(String[] args) throws Exception {
        String url = "http://localhost:9000" + PampasConsts.GATEWAY_REQ_PREFIX +
                "/spi_config_loader_key/" + PampasConsts.ConfigLoaderKey.SERVER_CONTEXT;
     ...
     * @param httpMethod   the http method
     * @return http client result
     * @throws Exception the exception
     */
    public static CloseableHttpResponse getHttpClientResult(CloseableHttpResponse httpResponse,
