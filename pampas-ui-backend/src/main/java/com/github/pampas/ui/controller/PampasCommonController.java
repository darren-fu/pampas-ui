...
import com.github.pampas.ui.service.PampasCommonService;
...
public class PampasCommonController {
    ...
    @Autowired
    private PampasCommonService pampasCommonService;
    ...
    public Response<Result<GatewaySpiResp>> getSpiList(@RequestParam(value = "spi", required = true) String spiClz,
        ...
        return pampasCommonService.getSpiClassList(spiClz, gatewayGroup, gatewayInstanceId);
    }
